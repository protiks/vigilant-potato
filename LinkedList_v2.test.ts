...
import  LinkedList_v2 from './LinkedList_v2'
...
describe('Linked-List Tests', () => {
  it('should create an empty list #1', () => {
    ...
    let list = new LinkedList_v2<number>(...values);
  ...
  it('should create an empty list #2', () => {
    ...
    let list = new LinkedList_v2<number>();
    expect(list.length).to.equal(0); 
    expect(list.head).to.be.null;
    expect(list.tail).to.be.null;
  });
  ...
  it('should create a LinkedList with a single value', () => {
    let list = new LinkedList_v2<number>(4);
  ...
  it('should allow "any" type', () => {
    ...
    let list = new LinkedList_v2<any>(...values);
    expect(list.length).to.equal(3);
    expect(list.head).to.equal(4);
  ...
  it('should allow custom types', () => {
    ...
    let list = new LinkedList_v2<Foo>(foo1, foo2, foo3, foo4);
  ...
  it('should prevent duplicates when appending primatives When setting ', () => {
    let values: number[] = [4, 5, 6]
    let list = new LinkedList_v2<number>(...values);
    expect(list.length).to.equal(3);
    expect(list.head).to.equal(4);
